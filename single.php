  ...
  <div class="container-fluid">
      ...
      <div class="col-md-5 offset-md-1">
        ...
        <div class="row" style="margin-top: 30px">
          <div class="col-md-6">
            <form>
              <tr>
                <td><label for="major"><b><h4> Kích thước: </h4></b></label></td><br>
          ...
          <div class="col-md-6">
            <form>
              <tr>
                <td><label for="major"><b><h4> Màu sắc: </h4></b></label></td><br>
        ...
        <div class="row" style="margin-top: 20px">
          <div class="col-md-6">
            <form>
              <tr>
                <td><label for="major"><b><h6> Số lượng: </h6></b></label></td><br>
    ...
    <div class="row" style="margin-top: 40px">
      ...
      <div class="col-md-3 offset-md-1">
        <p class="text-uppercase">Màu sắc</p><hr>
        <div class="row">
          <div class="col-md-2">
        ...
        <div class="row" style="margin-top: 30px">
          <p class="text-uppercase">Phong cách</p><hr>
          <div class="row">
            <div class="col-md-6">
              <form>
