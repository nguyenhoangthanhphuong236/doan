...
<body onload="autoloading()">
		...
		<div class="bao-bang">
			<div class="bang-n">
				<div class="row">
					<div class="col-md-3">
						<div class="row1">
							<div class="btn-group-vertical">
								...
								<video src="videos/aoquan.mp4" width="300" controls=""></video>
							</div>	
						</div>
						<div class="row1">
					...
					<div class="col-md-9">
						<div class="ten-bang">
							<h1 style="border-bottom: 3px rgb(212, 109, 12) solid;" class="sp">SẢN PHẨM HOT NHẤT TUẦN</h1>
						</div>
						<div class="san-pham">
							<div class="column">
								<div class="item-column">
									<img class="image" src="https://chiotshop.com/wp-content/uploads/2020/11/d327ef3e78d98487ddc8.jpg" / width="85%" height="150px">
							...
							<div class="column">
								<div class="item-column">
									<img class="image" src="https://havistore.net/wp-content/uploads/2020/01/Ao-kieu-nu-tay-phong-dai-HV-271-1.jpg" / width="85%" height="150px">
									<div class="ten-item-column">
										<a href="#">Áo kiểu</a>
									</div>
			...
			<div class="container-fluid" style="margin-top: 10px">
				<div class="row">
					...
					<div class="col-md-12 chinhanh" style="margin-top: 5px">
						<div class="uu-dai">
							<img src="./public/images/uudai.jpg" height="400px" width="100%" id="uudai-a">
			...
			<div class="san-pham">
				<div class="column">
					<div class="item-column">
						...
						<p class="gia">450.000 đ</p>
						<button class="btn btn-default"><a href="chitiet.html" style="color: brown">Xem chi tiết</a></button>
						<button class="btn btn-default add-to-cart" id="btn-cart">Đặt hàng</button>
					</div>
				</div>
				<div class="column">
	...
	<div class="tin-tuc">
		...
		<div class="column-tintuc">
			<div class="item-column-tintuc">
				<img class="image" src="https://scontent.xx.fbcdn.net/v/t1.15752-9/p206x206/220594316_4121461694589728_5574715530270066825_n.png?_nc_cat=109&ccb=1-3&_nc_sid=aee45a&_nc_ohc=b8mCNAgr3vkAX_Jbmew&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=7036c856413c6ef3f793b5553c75f6a7&oe=612388D5" />
				<div class="ten-item-column">
					<a href="#">MỪNG SINH NHẬT SHOP HN22 – SĂN ĐỒ THẢ GA</div></a>
				<p>“MỪNG SINH NHẬT SHOP HN22 – SĂN ĐỒ THẢ GA” Mừng sinh nhật lần thứ 4 của thương hiệu…</p>
	...
	<div class="container">	
		<div class="row text-center">
			<div class="col-md-3">
				<img class="chinhsua" src="https://png.pngtree.com/element_our/png_detail/20181228/delivery-truck-vector-icon-png_296956.jpg" >
				<p class="chinhchu">Free ship 64 tỉnh</p>
				<p>Áp dụng cho hóa đơn trên 500k.</p>
			</div>
			<div class="col-md-3">
				<img class="chinhsua" src="https://glovi.vn/wp-content/uploads/2018/04/chuong-goi-khong-day-icon-1521165655.png" >
				<p class="chinhchu">Đổi trả hàng miễn phí</p>
				<p>Trong vòng 1 tháng.</p>
			</div>
			<div class="col-md-3">
				<img class="chinhsua" src="http://bizweb.dktcdn.net/100/216/592/themes/707614/assets/icon-service-recieve-money.png?1621158435073" >
				<p class="chinhchu">Thanh toán tại nhà</p>
				<p>Kiểm tra hàng trước khi thanh toán.</p>
			</div>
			<div class="col-md-3">
				<img class="chinhsua" src="https://thumbs.dreamstime.com/b/authentic-stamp-red-authentic-stamp-sign-icon-illustration-authentic-stamp-red-authentic-stamp-icon-161667497.jpg" >
